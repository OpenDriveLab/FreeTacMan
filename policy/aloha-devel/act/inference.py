...
def model_inference(args, config, ros_operator, save_episode=True):
    ...
    # left1 = [-0.544915672, 1.5164592520000002, -0.9976572480000001, -0.112810348, 1.028882008, 0.23334838800000002, 0.0] # puppet left
    # right1 = [0.24941431200000003, 1.145093936, -1.099425544, -0.41631850400000003, 0.95122132, -0.17039299200000002, 0.00666] # puppet right
    # dummy pour cola
