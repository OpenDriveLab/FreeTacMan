...
from pretrain.clip_pretraining_resnet import modified_resnet18
from pretrain.clip_pretraining_vit import load_vit_encoder
...
class DETRVAE(nn.Module):
    ...
    def forward(self, image, depth_image, tactile_image, robot_state, actions=None, action_is_pad=None):
        ...
        if is_training and self.kl_weight != 0:  # hidden_dim 512
